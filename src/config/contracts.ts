...
// NOTE: Replace with actual deployed addresses before production
export const CONTRACT_ADDRESSES: Record<number, Record<TokenSymbol, string>> = {
  [CHAIN_IDS.ETHEREUM_MAINNET]: {
    ...
    BTC: "0x0000000000000000000000000000000000000000",  // Replace after deployment
    ETH: "0x0000000000000000000000000000000000000000",  // Replace after deployment
  },
  [CHAIN_IDS.SEPOLIA]: {
    USDT: "0x0000000000000000000000000000000000000000", // Replace after deployment
    BTC: "0x0000000000000000000000000000000000000000",  // Replace after deployment
